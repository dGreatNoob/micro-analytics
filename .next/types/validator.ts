...
// Validate ../../app/(dashboard)/dashboard/pages/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/dashboard/pages">> = Specific
  const handler = {} as typeof import("../../app/(dashboard)/dashboard/pages/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
...
// Validate ../../app/(dashboard)/dashboard/referrers/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/dashboard/referrers">> = Specific
  const handler = {} as typeof import("../../app/(dashboard)/dashboard/referrers/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
